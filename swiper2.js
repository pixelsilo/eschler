      ...
      const applyWidthReduction = () => {
        let currentWidthReduce = 0;
         ...
         if (currentWidthReduce > 0) {
          ...
          // Calculates the exact pixel width to prevent flex-child percent collapse bugs
          const containerWidth = swiperContainer.clientWidth || window.innerWidth;
          const slideWidth = containerWidth - currentWidthReduce;
